...
$(document).ready(function(event) {
  ...
  $(".fa-pencil").click(function (e) { 
    ...
    $.ajax({
      ...
      url: 'index.php/Backlog/geteditar', //index.php/
  ...
  $('#equipo').change(function(){
    ...
    $.ajax({
        ...
        url: 'index.php/Backlog/getcantidad', 
        success: function(data){
  ...
  $(".fa-file-text").click(function(){
    ...
    var idB=$(this).parent('td').parent('tr').attr('id'); 
    var ide = $(this).parent('td').parent('tr').attr('class');
    console.log("El id de BACK es:");
    console.log(idB);
    ...
    $.ajax({
      type: 'POST',
      data: { idB: idB, datos:datos},
      url: 'index.php/Backlog/getbacklog', //index.php/
      success: function(data){
              ...
              $.ajax({
                  type: 'POST',
                  data: { idB:idB, equipo: equipo, tarea:tarea, fecha:fecha},
                  url: 'index.php/Backlog/backloginertot', //index.php/
                  success: function(data){
...
function eliminarpred(){
  ...
  $.ajax({
    type: 'POST',
    data: { gloid: gloid},
    url: 'index.php/Backlog/baja_backlog', //index.php/
    success: function(data){
            //var data = jQuery.parseJSON( data );
...
function completarEdit(datos){
 ...
 // $('select#equipo').append($('<option />', { value: datos['id_equipo'],text: datos['codigo']}));
  ...
  //$('select#tarea').append($('<option />', { value: datos['tarea'],text: datos['desta']}));
  $('#fecha').val(datos['fecha']);
  $('#periodo').val(datos['periodo']);
  $('#cantidad').val(datos['cantidad']);
  $('#horash').val(datos['hora']);
...
function guardar(){
    ...
    $.ajax({
      type: 'POST',
      data: {tarea:tarea, fecha:fecha, equipo:equipo, gloid:gloid},
      url: 'index.php/Backlog/editar_backlog',  //index.php/
      success: function(data){
  ...
  <div class="modal-dialog" role="document" style="width: 60%">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><span id="modalActionSale" class="fa fa-fw fa-pencil" style="color: #A4A4A4"> </span> Backlog</h4> 
      </div>
...
<div class="modal fade" id="modalaviso">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <center>
        <button type="button" class="btn btn-primary" onclick="eliminarpred()">SI</button>
