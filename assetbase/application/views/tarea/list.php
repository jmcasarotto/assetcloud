...
$(document).ready(function(event) {
  ...
  $(".fa-pencil").click(function (e) { 
    ...
    var id_tarea = $(this).parent('td').parent('tr').attr('id');
    ...
    $.ajax({
        ...
        url: 'index.php/Tarea/getpencil', //index.php/
  ...
  $(".fa-times-circle").click(function (e) { 
    ...
    $.ajax({
            ...
            url: 'index.php/Tarea/baja_tarea', //index.php/
            success: function(data){
...
function guardareditar(){
  ...
  if( parametros !=0)
    ...
    $.ajax({
      type:"POST",
      url: "index.php/Tarea/edit_tarea", //controlador /metodo
...
function guardar(){
  ...
  if( parametros !="")
    ...
    $.ajax({
      type:"POST",
      url: "index.php/Tarea/agregar_tarea", //controlador /metodo
  ...
  <div class="modal-dialog modal-lg" role="document" style="width: 60%">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title"  id="myModalLabel"><span id="modalAction" class="fa fa-plus-square" style="color: #008000" > </span>  Agregar Tareas</h4>
       </div> <!-- /.modal-header  -->
        ...
        <div class="row" >
          <div class="col-sm-12 col-md-12">
            <div class="col-xs-12">Descripcion:
              <input type="text" id="descripcion" name="descripcion" class="form-control" placeholder="Ingrese Descripcion de Tarea...">
            </div>                   
          </div>
        </div>
      </div>
