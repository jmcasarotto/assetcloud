                  ...
                  <div class="row">
                      <div class="col-md-4 col-xs-12">
                          ...
                          <div class="info-box bg-green">
                              ...
                              <div class="info-box-content">
                                  ...
                                  <span class="info-box-number"><?php print_r($widgets['cant']); ?></span>
                                  <!-- The progress section is optional -->
                                  <div class="progress">
                                      <div class="progress-bar" style="width: 12%"></div>
                                  </div>
                                  <span class="progress-description">
                                      Hay <?php print_r($widgets['cant']); ?> ordenes en curso del último mes.
                                  </span>
                      ...
                      <div class="col-md-4 col-xs-12">
                          <div class="info-box bg-yellow">
                              ...
                              <div class="info-box-content">
                                  <span class="info-box-text">Acumulación mantenimiento</span>
                                  <span class="info-box-number">18/01/2017</span>
                                  <!-- The progress section is optional -->
                                  <div class="progress">
                                      <div class="progress-bar" style="width: 100%"></div>
                                  </div>
                                  <span class="progress-description">
                                      Hay 11 mantenimientos programados ese día.
                                  </span>
                              </div><!-- /.info-box-content -->
                          </div><!-- /.info-box -->
                      </div>
                      ...
                      <div class="col-md-4 col-xs-12">
                          <div class="alert alert-success alert-dismissible">
                              ...
                              <h4><i class="icon fa fa-info-circle"></i> 23 mantenimientos</h4>
                              Se realizaron 23 mantenimientos en los últimos 30 días.
                          </div>
                      </div>
...
<script>
  ...
  $(".fa-print").click(function (e) {
    ...
    $.ajax({
        ...
        url: 'index.php/Sservicio_solicitante/getsolImp', //index.php/
  ...
  $( function() {
      ...
      var dataF = function () {
          ...
          $.ajax({
              ...
              'global': false,
              'dataType': 'json',
              'url': "Sservicio_solicitante/getSector",
              'success': function (data) {
                  tmp = data;
              }
          });
      ...
      function getEquiSector(idSect){
        ...
        $.ajax({
                ...
                'global': false,
                'dataType': 'json',
                'url': "Sservicio_solicitante/getEquipSector",
                'success': function (data) {
    ...
    //WaitingOpen('Guardando cambios');
    	$.ajax({
          	...
          	data: {
        		...
        		url: 'index.php/Sservicio_solicitante/setservicios',
        		success: function(result){
                    		//WaitingClose('Guardado exitosamente...');
                    		var permisos = '<?php echo $permission; ?>';
