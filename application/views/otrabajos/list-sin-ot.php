              ...
              <?php
                if(count($list) > 0) { 
                  ...
                  $usrId= $userdata[0]['usrId']; 
                    ...
                    //echo "grupo";
                    //echo $gr; ($a['grpId']=='1') ||
                    if(($a['grp'] =='1') && (($a['id_usuario'] == $usrId ) || ($a['id_usuario'] !== $usrId ))) { 
                      ...
                      if (($a['estado'] !=='T') && ($a['estado'] !=='E')  && ($a['estado'] !=='TE') && ($a['estado'] !=='AN')) {
                      ...
                      if(($a['id_usuario_a'] == $usrId ) && (($a['grp'] !=='1') || ($a['grp'] =='1') )){
...
function orden(){
  ...
  $.ajax({
      type: 'POST',
      data: {fecha_entrega:fecha_entrega, usuario:usuario, id_orden:id_orden},
