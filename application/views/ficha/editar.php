                ...
                <div class="panel-body">
                  ...
                  <div class="col-xs-4">Numero de serie <strong style="color: #dd4b39">*</strong>:
                    ...
                    <div class="col-xs-4">Marca del motor <strong style="color: #dd4b39">*</strong>:
                      <input type="text" id="marcamoto" name="marcamoto" class="form-control" value="<?php echo $list[0]['marca'] ?>">
                    </div>
                    ...
                    <div class="col-xs-4">Numero del motor <strong style="color: #dd4b39">*</strong>:
                      <input type="text" id="numeromoto" name="numeromoto" class="form-control" placeholder="Ingrese NUmero de motor..." value="<?php echo $list[0]['numero_motor'] ?>">  
                    </div>
...
function guardarficha(){
  ...
  $.ajax({
    type: 'POST',
    data: {data:parametros, idglob: idglob},
    url: 'index.php/Equipo/editar_ficha',  //index.php/
    success: function(data){
