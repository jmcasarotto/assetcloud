 ...
 {     //alert("si guardo ");
     ...
     //$('#sales').append(parametros);
      ...
      console.log(comp2);
          ...
          $.ajax({
                type: 'POST',
                data: {equipo:equipo, tarea:tarea, periodo:periodo, cantidad:cantidad, ultimo:ultimo, componente:componente, cantidadhm:cantidadhm, idsherramienta:idsherramienta,comp:comp, idsinsumo:idsinsumo, comp2:comp2},
