    ...
    <div class="col-xs-12">
      <div class="box">
        ...
        <br>
          ...
          <!-- <input type="text" name="fecha" id="ejemplo1" value="" /> -->
            ...
            <tbody>
              <?php
                  ...
                  foreach($list['data'] as $a){ 
                    ...
                    echo '<td style="text-align: center">'.$a['de12'].'</td>';
                    echo '<td style="text-align: center">'.$a['de13'].'</td>';
                    echo '<td style="text-align: center">'.$a['de11'].'</td>';
                    echo '<td style="text-align: center">'.$a['de14'].'</td>';
                    ...
                    .($a['estado'] == 'AC' ? '<small class="label pull-left bg-green" >Activo</small>' 
                      ...
                      :($a['estado'] == 'R' ? '<small class="label pull-left bg-blue">Reparacion</small>' 
  ...
  $(".fa-sticky-note-o").click(function(e){
   ...
   /* $('#codigo').html("");
    ...
    $.ajax({
          type: 'POST',
          data: {cod:cod }, 
          url: 'index.php/Equipo/getdatosficha', //index.php/
          success: function(data){
                  ...
                  var sector = data[0]['desect'];
                  var estado = data[0]['estado'];


                 // $('select#codigo').append($('<option />', { value: data[0]['id_equipo'],text: data[0]['codigo']}));
                  $('#codigo').val(codigo);
      ...
      success: function(data){
                   if(data!== 'nada' ){
                      ...
                      //alert("El equipo , SI tiene datos tecnicos cargados");
                        ...
                        //   $('#error1').fadeOut('slow');
                        // }
                       // alert("El equipo , NO tiene datos tecnicos cargados");
...
// agrega el estado del boton en modal lectura
function estBoton(data){
    
    var estado = data[0]['estado'];
    
    if (estado == 'R') {  //reparacion
      inhabilitar();          
    }
    if (estado == 'AC') {  //operativo
      habilitar();
    }
}
      ...
      <div class="modal-body input-group ui-widget" id="modalBodyArticle"> 
        <form id="formlectura">
          <div class="row" >
            ...
            <div class="col-sm-12 col-md-12">Horometro<strong style="color: #dd4b39">*</strong>:
                <input type="text" id="lectura" name="lectura" class="form-control clear"> 
            </div> </br></br>           

            <!-- <div class="col-sm-12 col-md-12">Fecha y Hora<strong style="color: #dd4b39">*</strong>: 
